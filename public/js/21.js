  ...
  return _c("layout", [
    _c(
      ...
      _vm._l(_vm.posts, function(post) {
        return _c("card", { key: post.uuid, staticClass: "mb-10" }, [
          _c("div", { staticClass: "flex" }, [
            _c("div", { staticClass: "w-64 mr-5 rounded-lg bg-gray-100" }, [
              _c("img", {
                staticClass: "object-cover rounded-lg",
                attrs: { src: post.image_full_path }
              })
            ]),
            _vm._v(" "),
            _c(
              ...
              [
                _c(
                  ...
                  [
                    _c("a", { attrs: { href: "/post/" + post.id + "/show" } }, [
                    ...
                    [
                      _c(
                        ...
                        [
                          _c("avatar", {
                            staticClass: "mr-3",
                            attrs: { name: post.user.name, color: "blue" }
                          })
                        ],
                        1
                      ),
                      _vm._v(" "),
                      _c("heading", [_vm._v(_vm._s(post.user.name))])
                    ],
                    1
                  ),
                  _vm._v(" "),
                  _c("div", { staticClass: "mx-4 text-gray-600" }, [
                    _vm._v("•")
                  ]),
                  _vm._v(" "),
                  _c("div", [
                    _c(
                      "a",
                      { staticClass: "text-blue-600", attrs: { href: "#" } },
